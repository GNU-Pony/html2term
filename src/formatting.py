...
format_dl         = lambda lines, **_attrs : lines
format_dd         = lambda lines, **_attrs : ['', 0] + format_(lines, None, ' ' * 4, 4)
format_dt         = lambda lines, **_attrs : ['', 0] + format_(lines, '01')
...
FORMAT_MAP += ' dfn acronym abbr li th dl'
